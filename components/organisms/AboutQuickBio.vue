  ...
  <article class="px-8 max-w-4xl mx-auto" aria-label="quick bio">
    ...
    <div>
      <section class="flex flex-col md:flex-row mb-8">
        ...
        <div class="w-full md:w-9/12 lg:w-3/4">
          ...
          >
            <div class="badge">
              ...
              know more about me:
              <a class="font-bold" href="/about/my-story">Read my story</a>
            </div>
          </div>
        </div>
      </section>
      <div class="flex flex-col md:flex-row mb-8">
        <section class="w-full md:w-9/12 xl:w-3/4 mb-4">
          ...
          Windows and is there an alternative. The answer was Yes!<a
            class="bio-link"
            href="https://wiki.ubuntu.com/JauntyJackalope"
            >Ubuntu 9.04 (Jaunty Jackalope)</a
          ...
          are<a class="bio-link" href="https://kubuntu.org/">Kubuntu 20.10</a
          >,<a class="bio-link" href="https://manjaro.org/">Manjaro"</a>and<a
            class="bio-link"
            href="https://archlinux.org/"
            >Arch Linux</a
          >. I use<a class="bio-link" href="https://kde.org/">KDE</a>as my GUI
          "you know what they say old habits die hard." Yes, I occasionally use
          Windows. After I built my next PC, I got<a
            class="bio-link"
          ...
          of nostalgia with my mom. Which lead me to learn C# from<a
            class="bio-link"
          ...
          <a class="bio-link" href="https://ubuntu.com/server">
            Ubuntu Linux server
          </a>
          ...
          <a class="bio-link" href="https://pandas.pydata.org/">pandas</a>,<a
            class="bio-link"
            href="https://numpy.org/"
            >NumPy
          </a>
          and
          <a class="bio-link" href="https://matplotlib.org/">matplotlib </a>
