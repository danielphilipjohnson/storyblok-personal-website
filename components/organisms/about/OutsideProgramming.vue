      ...
      <ul class="bio-list">
        <li class="bio-list-item">
          <a
            ...
            >Habits for success Inspired Ideas to help you soar: Brian Benson</a
          >
        </li>
        <li class="bio-list-item">
          <a
        ...
        <li class="bio-list-item">
          <a
            ...
            >The first 20 hours: Josh Kaufman</a
          >
        </li>
        <li class="bio-list-item">
          <a
            ...
            >The next big thing: Matthew Mockridge</a
          >
        </li>
        <li class="bio-list-item">
          <a
            ...
            >GET IT DONE 31 Ways to release your inner boss: Hayley Hobson</a
          >
        </li>
      </ul>
      <p class="mb-4 leading-7">
